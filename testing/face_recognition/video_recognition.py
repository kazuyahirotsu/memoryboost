...
# linus_face_encoding = face_recognition.face_encodings(linus_image)[0]

# # Load a second sample picture and learn how to recognize it.
# james_image = face_recognition.load_image_file("images/james.jpg")
...
for image in os.listdir("images"):
    ...
    try:
        ...
        exec('known_face_encodings.append({}_face_encoding)'.format(name))
