...
def main(model_arg, scorer_arg, audio_arg):
    ...
    if not args.scorer:
        args.scorer = scorer_arg
    if not args.audio:
        args.audio = audio_arg  
    ...
    if args.extended:
        ...
        return metadata_json_output(ds.sttWithMetadata(audio, args.candidate_transcripts))
    else:
        print(ds.stt(audio))
        return ds.stt(audio)
...
if __name__ == '__main__':
    main(model_arg="deepspeech-0.9.3-models.pbmm",scorer_arg="deepspeech-0.9.3-models.scorer",audio_arg="../face_recognition/audio/lmg.wav")
